...
* [概要](#概要)
* [基本構成](#基本構成)
  * [別途検討が必要なケース](#別途検討が必要なケース)
* [構成の深掘り](#構成の深掘り)
  * [フロントエンド](#フロントエンド)
  * [バックエンド](#バックエンド)
  * [その他](#その他)
* [Terraformガイドライン](#terraformガイドライン)
...
* データ分析
  ...
  * 仮に予算上Read Replicaを用意することができず、かつPrimaryへの負荷を許容することができない場合、Datastreamの採用を検討する。ただし、リアルタイムの分析ができない（最短5分間隔のニアリアルタイムであれば可能）、構築・運用にそこそこコストがかかるなどトレードオフを理解して採用すること。
    * 参考: [DatastreamによるCRMのデータ同期とアーキテクチャの最適化](https://tech.buysell-technologies.com/entry/adventcalendar2023-12-20)
* 監視、アラート
